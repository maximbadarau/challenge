...
public class AccountsController {
  ...
  public ResponseEntity<Object> fundsTransfer(@PathVariable String accountId, @RequestBody @Valid FundsTransfer fundsTransfer) {
    log.info("Funds transfer from account {}", accountId);
    try {
    this.fundTransferService.executeFundsTransfer(accountId, fundsTransfer);
    } catch (DuplicateAccountIdException daie) {
      return new ResponseEntity<>(daie.getMessage(), HttpStatus.BAD_REQUEST);
    }
